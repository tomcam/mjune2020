...
theme="marlow"
sidebar="right"
# http://jsfiddle.net/viphalongpro/Hj8Nn

===

#### **NEWS** | *Tom Campbell*  ~~{{ ftime "January 02, 2006" }}~~
###### Description: The city's fabled waterfront. (Image credit: Stocksnap.io)
![Picture of city on waterfront](img-sample-waterfront-800x533.jpeg)
#### *HEY*

# Marlow

* It's hard to find current information on Google Apps Script best practices
* This article presents a complete, reusable sidebar app following best practices
* Apps Script forms differ sharply from Google Forms, because Apps Script forms are
actually generated using Javascript, even though they look like standard HTML
